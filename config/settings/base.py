...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(ROOT_DIR, 'db.wecode'),
    }
}
...
MIGRATION_MODULES = {
    'sites': 'wecode.contrib.sites.migrations'
}
...
REST_AUTH_REGISTER_SERIALIZERS = {
    'REGISTER_SERIALIZER': 'wecode.users.serializers.SignUpSerializer'
}
